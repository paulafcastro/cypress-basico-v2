...
describe('Central de Atendimento ao Cliente TAT', function() {  
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        cy.get('#firstName')
            ...
            .should('have.value', '')
        cy.get('#lastName')
            .type('Fernandes de Castro')
            .should('have.value', 'Fernandes de Castro')
            .clear()
            .should('have.value', '')
        cy.get('#email')
            .type('paula.fcastro@live.com')
            .should('have.value', 'paula.fcastro@live.com')
            .clear()
            .should('have.value', '')
        cy.get('#phone')
            .type('11911920610')
            .should('have.value', '11911920610')
            .clear()
            .should('have.value', '')
    })
    ...
    it('verifica que a política de privacidade abre sem a necessidade de um clique', function() {
